(function () {
  ...
  const HEART =
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12.2 20C10.5 18.4 5.5 15.8 3.6 11.9C2.2 9.1 3.4 6 6.6 6c1.8 0 3 1.1 3.6 2.2C10.8 7.1 12 6 13.8 6c3.2 0 4.4 3.1 3 5.9C15.4 15.8 13.9 18.4 12.2 20Z"/></svg>';
  const FOLDER_MARK =
